...
Relay.prototype.create = function($happn, opts, callback) {
  this.client.createRelay($happn, opts, callback);
}

Relay.prototype.destroy = function($happn, token, callback) {
  this.client.destroyRelay($happn, token, callback);
}

Relay.prototype.list = function(callback) {
  callback(null, {
    running: this.client.running,
    starting: this.client.starting,
    stopping: this.client.stopping,
  });
}

Relay.prototype.listServer = function(callback) {
  callback(new Error('Not yet implemented'));
}

Relay.prototype.destroyServer = function($happn, token, callback) {
  this.server.destroyRelay($happn, token, callback);
}
